...
<!-- <body> -->
    <div class="header">
        ...
        <div class="head-right">
            <span class="text-h  text-h-name ">نام کاربر</span>
            <span id="text-add" class="text-h hide text-h-add" onclick="new_ticket()">ثبت تیکت جدید</span>
    ...
    <div id="new-ticket" class="contianer-add-ticket">
        <div class="add-ticket" dir="rtl">
            <form action="">
                <p id="button-back" class="btn-back" onclick="new_ticket()">
            ...
            <div class="replay-massage">
                ...
                <div class="send-recive-massage">
                    <div class="send-massage">
                        <p class="margin-massage">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui esse, odio inventore ratione error atque a, laborum blanditiis quo quia voluptate repellat ut voluptates reiciendis pariatur in, possimus laboriosam nemo.</p>
                        <span class="margin-massage">14:23</span>
                        <span class="margin-massage">1401/2/10</span>
                    </div>
                    <div class="recive-massage">
                        <!-- <p class="margin-massage"></p>
